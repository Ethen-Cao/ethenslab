...
title = '项目关键活动跟踪单'
+++
# PROJECT_A OTA 功能规格说明书

## 1. 基本信息

| 项目名称 (Project Name)     | PROJECT_A |
| :---------------------- | :------------- |
...
本节给出 PROJECT_A OTA 的**能力地图**与**状态流转视图**。
...
* FT-SCH-01 自动夜间预约：默认策略（如 02:00-04:00），智能避开用户用车规律。
  * <font color="red">本条需求在《VCOS-OTA HMI显示需求文档 v1.4》中已经删除，本文档依然记录在此，但对于 PROJECT_A 项目不做要求</font>。
