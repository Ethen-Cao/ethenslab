...
![WindowState 创建时序示意图](../../../static/images/windowstate-creation.png)
...
* Binder IPC 调用：ViewRootImpl 通过一个名为 IWindowSession 的 Binder 接口，向 WMS 发起一个远程调用，通常是 addToDisplay()。这个调用会携带两个核心信息：
    * Window Token: 一个唯一的 Binder 令牌，用于将这个窗口与 AMS 中的 ActivityRecord 关联起来，WMS据此知道这个窗口属于哪个Activity。
    ![WindowToken创建与使用示意图](../../../static/images/windowtoken-creation-transport.png)
...
![Window Type到Feature的映射关系表](../../../static/images/windowtype-2-feature.png)
...
![Android 14+ 分屏启动时序图](../../../static/images/seq-split-screen-start.png)
...
![](../../../static/images/window-visible.png)
...
![](../../../static/images/WindowAnimation.png)
