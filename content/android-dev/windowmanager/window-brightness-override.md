...
## 亮度设置失败导致SurfaceFlinger合成策略终止的时序图
...
title 亮度设置失败导致合成策略终止的全链路时序图

box "SurfaceFlinger 进程 (Guest OS)" #LightGreen
...
box "HWC Service 进程 (Guest OS)" #LightYellow
...
box "Kernel / FileSystem" #LightBlue
